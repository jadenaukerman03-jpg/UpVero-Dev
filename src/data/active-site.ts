 ...
 */
const developmentSiteKey = import.meta.env.DEV ? import.meta.env["VITE_SITE_CONFIG"] : undefined;

export const activeSiteConfig: SiteConfig =
  developmentSiteKey === "summitPeakRoofing" ? siteConfigs["summitPeakRoofing"] : defaultSiteConfig;
